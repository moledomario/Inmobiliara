...
export default function Footer() {
    ...
    return (
        <footer className="bg-gray-900/95 backdrop-blur-lg border-t border-cyan-500/20">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
                    ...
                    <div className="lg:col-span-1">
                        ...
                        <p className="text-gray-400 text-sm leading-relaxed mb-4">
                            Tu aliado de confianza en el mercado inmobiliario. Encuentra la propiedad perfecta para ti.
                        </p>
                        {/* Social Links */}
                ...
                <div className="pt-8 border-t border-gray-800">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                        ...
                        <div className="flex gap-6 text-sm">
                            <a href="#terminos" className="text-gray-500 hover:text-cyan-400 transition-colors">
                                Términos
                            </a>
                            <a href="#privacidad" className="text-gray-500 hover:text-cyan-400 transition-colors">
                                Privacidad
                            </a>
                            <a href="#cookies" className="text-gray-500 hover:text-cyan-400 transition-colors">
                                Cookies
                            </a>
                        </div>
                    </div>
